        ...
        >
          <div class="relative overflow-hidden rounded-2xl bg-black/5 dark:bg-white/5 p-8">
            ...
            <div class="relative z-10">
              <div class="w-32 h-32 bg-primary/20 rounded-full mx-auto mb-6 overflow-hidden">
                <img
              ...
              <div class="mt-4">
                <a
                  ...
                  class="text-gray-600 hover:text-primary transition-colors flex items-center gap-2"
                >
...
const translations = {
  en: {
    ...
    team: {
      member1: {
        name: 'Aleksis Aleksandrs Vējš',
        role: 'Full Stack Developer',
        skills: ['Vue.js', 'Laravel', 'Native CSS', 'JavaScript'],
      },
      member2: {
