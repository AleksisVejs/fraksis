<template>
  <section class="section relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto w-full relative z-10">
      ...
      <!-- Company Description -->
      <div
        class="text-center max-w-3xl mx-auto mb-16 animate-on-scroll"
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        >
          <div class="relative overflow-hidden rounded-2xl bg-black/5 dark:bg-white/5 p-8">
            <div
            ...
            <div class="relative z-10">
              <div
                class="w-32 h-32 bg-primary/20 rounded-full mx-auto mb-6 overflow-hidden relative"
              >
                <div
              ...
              <p class="text-primary text-center mb-6">
              ...
              <div class="flex flex-wrap gap-2 justify-center">
                <span
                  ...
                  :key="skill"
                  class="px-3 py-1 bg-primary/20 text-primary rounded-full text-sm transform hover:scale-105 transition-transform duration-200"
                >
                  {{ skill }}
                </span>
              </div>
              <div class="mt-6 flex justify-center space-x-4">
                <a
                  ...
                  class="text-gray-600 hover:text-primary transition-colors transform hover:scale-110"
                >
