...
<template>
  <nav class="site-nav" :class="{ open: menuOpen }" aria-label="Primary">
    ...
    <div class="nav-backdrop" aria-hidden="true" @click="closeMenu"></div>
    <ul id="primary-navigation" class="nav-links">
      ...
      <li>
        <a href="https://github.com/AleksisVejs" target="_blank" class="nav-icon" title="GitHub" @click="closeMenu">
      ...
      <li>
        <a href="https://linkedin.com/in/aleksis-vejs" target="_blank" class="nav-icon" title="LinkedIn" @click="closeMenu">
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
